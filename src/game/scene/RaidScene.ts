...
const TOWN_WAR_VISUAL_TRENCH_FIRE_RANGE_FRONT_MULTIPLIER = 1.2;
const TOWN_WAR_VISUAL_TRENCH_FIRE_RANGE_ANGLED_MULTIPLIER = 1.1;
const TOWN_WAR_VISUAL_TRENCH_FIRE_RANGE_ENFILADED_MULTIPLIER = 0.9;
