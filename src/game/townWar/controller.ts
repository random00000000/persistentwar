...
const TRENCH_FIRE_RANGE_FRONT_MULTIPLIER = 1.2;
const TRENCH_FIRE_RANGE_ANGLED_MULTIPLIER = 1.1;
const TRENCH_FIRE_RANGE_ENFILADED_MULTIPLIER = 0.9;
...
const SUPPRESSION_RETREAT_THRESHOLD = 0.8;
...
const TOWN_WAR_DEMOLITION_TOOL_DAMAGE: Record<TownWarDemolitionToolId, { weakPoint: number; camp: number; ammoCost: number; buildCost: number }> = {
  ...
  rpg: { weakPoint: 350, camp: 260, ammoCost: 46, buildCost: 12 }
};
